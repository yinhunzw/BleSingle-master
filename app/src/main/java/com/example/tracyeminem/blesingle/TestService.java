...
import com.example.tracyeminem.blesingle.util.DateTimeUtils;
import com.example.tracyeminem.blesingle.util.SharedPreferenceUtil;
...
//        callbackIntent = PendingIntent.getActivity(this, 1, intent2, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        Log.e("EEEEEE","-----"+(System.currentTimeMillis() - lastScreentActionTime)/1000);
        ...
        if((current - lastScreentActionTime) / 1000 >= DateTimeUtils.ONE_MINUTE * 15){
            //onClose();
            //onOpen();
        }
...
//        builder2.setServiceUuid(ParcelUuid.fromString("9DB9ED9F-C03A-4ACC-8607-21AE59FAD7B5"), parcelUuidMask);
//        builder2.setServiceUuid(ParcelUuid.fromString("0X0BDF4215-AABC-4505-A0DB-2C797FB2811E"));
