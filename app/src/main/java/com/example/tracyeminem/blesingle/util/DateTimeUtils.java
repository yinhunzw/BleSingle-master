package com.example.tracyeminem.blesingle.util;
...
public final class DateTimeUtils {
    ...
    public static LinkedHashMap<String, Long> generateOndemandBookingSlot(int days){
        ...
        if(days == 0){
            firstAvailableSlot = (DateTimeUtils.getCurrentTimestamp() / 1800 + 1) * 1800;
            lastAvailableSlot = (DateTimeUtils.getCurrentTimestamp() / 86400 + 1) * 86400 - 1800 - 28800;
        }else{
            firstAvailableSlot = (DateTimeUtils.getCurrentTimestamp() / 86400 + days) * 86400 - 28800;
